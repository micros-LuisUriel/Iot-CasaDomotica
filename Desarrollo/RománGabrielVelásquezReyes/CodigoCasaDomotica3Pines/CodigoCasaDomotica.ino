...
#define WLAN_SSID       "INFINITUM5D9E_2.4"

#define WLAN_PASS       "Bacon10deMayo"

#define AIO_SERVER      "io.adafruit.com"

#define AIO_SERVERPORT  1883                  

#define AIO_USERNAME    "romanvelrey"

#define AIO_KEY         "aio_PZGZ44vLXiCIcMORzCMCh7UJlZW7"
...
Adafruit_MQTT_Subscribe LED_Control3 = Adafruit_MQTT_Subscribe(&mqtt, AIO_USERNAME "/feeds/LED_Control3");
...
////////////////////////////////////////////////////
 if (subscription == &LED_Control3) {

      Serial.print(F("Got: "));

      Serial.println((char *)LED_Control3.lastread);

       if (!strcmp((char*) LED_Control3.lastread, "ON3"))
